...
public class VectorTrafficLayersFunctionalExample extends BaseFunctionalExampleModel {

    public int getPlayableTitle() {
        return R.string.traffic_vector_layers_title;
    }

    public int getPlayableSubtitle() {
        return R.string.london_city_name;
    }
