...
public class EntryPointsSearchFragment extends ExampleFragment<EntryPointsSearchPresenter> {

    @Override
    protected EntryPointsSearchPresenter createPresenter() {
        return new EntryPointsSearchPresenter();
    }

    @Override
    protected void onOptionsButtonsView(OptionsButtonsView view) {
        view.addOption(R.string.btn_text_airport);
        view.addOption(R.string.btn_text_shopping_mall);
    }
