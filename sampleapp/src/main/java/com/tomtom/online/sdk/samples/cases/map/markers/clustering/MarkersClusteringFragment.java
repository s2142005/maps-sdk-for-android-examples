...
public class MarkersClusteringFragment extends ExampleFragment<MarkersClusteringPresenter> {
    ...
    @Override
    protected MarkersClusteringPresenter createPresenter() {
        return new MarkersClusteringPresenter();
    }
