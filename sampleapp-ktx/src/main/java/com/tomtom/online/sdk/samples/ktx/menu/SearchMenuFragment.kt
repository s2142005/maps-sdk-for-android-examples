...
class SearchMenuFragment : MenuFragment() {
    ...
    companion object {
        val MENU_ITEMS = listOf(
                MenuItem(title = R.string.menu_search_address_title,
                ...
                MenuItem(title = R.string.menu_category_search_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_language_parameter_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_typeahead_search_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_max_fuzziness_param_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_reverse_geocoding_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_along_route_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_geometry_search_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_entry_points_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_entry_adp_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_batch_search_title,
                        icon = R.drawable.ic_map_menu_icon,
                ...
                MenuItem(title = R.string.menu_search_entry_rev_geo_polygons_title,
                        icon = R.drawable.ic_map_menu_icon,
