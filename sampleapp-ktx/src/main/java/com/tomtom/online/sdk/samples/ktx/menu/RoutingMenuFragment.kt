...
class RoutingMenuFragment : MenuFragment() {
    ...
    companion object {
        val MENU_ITEMS = listOf(
                ...
                MenuItem(title = R.string.menu_long_ev_title,
                        icon = R.drawable.ic_map_menu_icon,
                        description = R.string.menu_long_ev_description,
                        banner = R.drawable.ic_routing_menu_long_ev_routing,
                        onClickNavigateTo = R.id.routeLongEvFragment),
