...
class TrafficMenuFragment : MenuFragment() {

    companion object {
        val MENU_ITEMS = listOf(
                MenuItem(title = R.string.menu_traffic_incident_list_title,
                        icon = R.drawable.ic_map_menu_icon,
                        description = R.string.menu_traffic_incident_list_description,
                        banner = R.drawable.ic_traffic_menu_traffic_incident_list,
                        onClickNavigateTo = R.id.trafficIncidentListFragment))
    }
